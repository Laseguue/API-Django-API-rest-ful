# Generated by Django 4.2.5 on 2023-09-06 14:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('BE', 'back-end'), ('FE', 'front-end'), ('iOS', 'iOS'), ('Android', 'Android')], max_length=10)),
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='api.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Issue',
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('assigned_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assigned_issues', to='api.customuser')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_issues', to='api.customuser')),
